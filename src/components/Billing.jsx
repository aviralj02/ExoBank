...
const Billing = () => {
  return (
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className='absolute z-[3] -left-1/2 top-60% w-[50%] h-[50%] rounded-full white__gradient' />
      <div className='absolute z-[0] -left-1/2 top-80% w-[50%] h-[50%] rounded-full pink__gradient' />
