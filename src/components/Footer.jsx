        ...
        <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
                         ...
                         <div key={index} className='flex flex-col ss:my-0 my-4 min-w-[150px]'>
                            ...
                            <ul className="list-none mt-3">
                                {fLink.links.map((link, index) => (
                                    <li key={link.name} className={`font-poppins font-normal text-[16px] leading-[24px] text-dimWhite cursor-pointer ${styles.linkHover} ${index !== link.length - 1 ? 'mb-2' : 'mb-0'}`}>
                                        {link.name}
                                    </li>
                                ))}
                            </ul>
            ...
            <div className="flex w-full justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3e45]">
                <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">
                    2023 ExoBank. All Rights Reserved
                </p>
